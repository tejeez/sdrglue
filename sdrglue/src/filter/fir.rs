...
// TODO: maybe convert to use the Sample type
// and make vector size a constant that can be more easily adjusted.
// This is now directly reused from another project.
